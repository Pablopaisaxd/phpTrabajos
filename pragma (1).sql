...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 23-10-2025 a las 02:06:24
...
INSERT INTO `accounts` (`IdAccount`, `Email`, `Contrasena`, `UltimaModificacion`) VALUES
(1, 'nose', '1234aeiou', '2025-10-22 14:56:41'),
(2, 'asdasd', '443f3', '2025-10-22 14:56:41'),
(3, 'nose', 'nose', '2025-10-22 15:48:41');
...
ALTER TABLE `reservas_pasajeros`
  ADD PRIMARY KEY (`IdRelacionrp`),
  ADD UNIQUE KEY `IdReserva` (`IdReserva`,`IdPasajero`),
  ADD KEY `IdPasajero` (`IdPasajero`),
  ADD KEY `IdReserva_2` (`IdReserva`,`IdPasajero`),
...
--
-- AUTO_INCREMENT de la tabla `reservas_pasajeros`
--
ALTER TABLE `reservas_pasajeros`
  MODIFY `IdRelacionrp` int(11) NOT NULL AUTO_INCREMENT;
...
ALTER TABLE `reservas`
  ...
  ADD CONSTRAINT `reservas_ibfk_2` FOREIGN KEY (`IdAccount`) REFERENCES `accounts` (`IdAccount`) ON DELETE CASCADE;
...
ALTER TABLE `reservas_pasajeros`
  ...
  ADD CONSTRAINT `reservas_pasajeros_ibfk_3` FOREIGN KEY (`IdSilla`) REFERENCES `sillas` (`IdSilla`);
